        ...
        <section className="space-y-4">
          <div className="flex flex-col items-center gap-4">
            <div className="flex items-center justify-center gap-3">
              ...
              <h2 className="text-3xl sm:text-4xl font-black text-slate-800 italic uppercase tracking-tighter">CORE VALUES</h2>
            </div>
          </div>
          <div className="w-full bg-[#fffef0] rounded-[2rem] sm:rounded-[3rem] p-4 sm:p-10 border border-[#fef9c3]/50 shadow-2xl space-y-6 sm:space-y-8">
