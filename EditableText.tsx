...
export const EditableText: React.FC<EditableTextProps> = ({ 
  ...
  return (
    <span
      ...
      className={`cursor-text hover:bg-slate-50 transition-colors px-1 -mx-1 rounded break-words word-break ${strikethrough ? 'line-through text-slate-400 opacity-60' : ''} ${className}`}
    >
