...
export const GoalCard: React.FC<GoalCardProps> = ({ 
  ...
  return (
    <div className="group bg-white rounded-xl sm:rounded-2xl border border-slate-100 p-4 sm:p-6 shadow-sm hover:shadow-md transition-all space-y-3">
      {/* 첫 번째 줄: 텍스트와 삭제 버튼 */}
      ...
      <div className="flex items-center gap-3 flex-wrap">
        <div className="flex items-center gap-1.5 bg-slate-50/80 p-1 rounded-xl border border-slate-100">
          ...
          <button 
            ...
            className={`p-1.5 transition-colors ${goal.memo ? 'text-indigo-500 bg-indigo-50 rounded-lg' : 'text-slate-300 hover:text-indigo-500'}`}
            title="메모"
          >
        ...
        <div className="flex-1 min-w-[200px] flex items-center gap-3">
          ...
          <div className="flex items-center gap-1 bg-slate-50/80 p-1 rounded-xl border border-slate-100 shrink-0">
